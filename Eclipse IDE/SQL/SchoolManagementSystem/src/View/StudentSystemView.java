...
public class StudentSystemView extends JFrame {
	...
	public StudentSystemView() {
		...
		btnLuu.setBounds(25, 438, 129, 23);
		panel.add(btnLuu);
		...
		rdbtnNu.setBounds(691, 184, 59, 23);
		...
		btnChonAnh.setBounds(264, 266, 89, 23);
	...
	public Student thucHienLuu() {
		...
		String anh="";
		if(duongdananh==null) {
			anh = StudentSignDao.getInstance().selectStudent(Integer.valueOf(this.lblMaThiSinh.getText())).getAnh();
		} else {
	...
	public void xoaForm() {
		...
		this.lblanh.setIcon(this.ResizeImage(""));
	}
