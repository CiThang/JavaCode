...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			...
			// Create JavaFX controls (nodes) to add the GridPane
			...
			// grid.add(..., columnIndex, rowIndex, colspan, rowspan);
			// Thêm Button vào GridPane tại cột 0, hàng 0, chiếm 2 cột và 1 hàng
