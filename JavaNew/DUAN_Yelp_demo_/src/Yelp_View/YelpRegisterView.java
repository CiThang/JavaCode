...
public class YelpRegisterView extends JFrame {
	...
	public YelpRegisterView() {
		...
		JLabel lblNewLabel_3 = new JLabel(
				"Cùng nhau xây dựng lên một cộng đồng mạnh mẽ để quảng bá ẩm thực Việt Nam nào");
	...
	public YelpUserAccount ThongtinUser() {
		String ho = textFieldHo.getText();
		String ten = textFieldTen.getText();
		String taikhoan = textFieldTenTaiKhoan.getText();
		...
		if (duongdananh == null) {
			...
			anh = String.valueOf(duongdananh);
		}
		YelpUserAccount userAccount = new YelpUserAccount(ho, ten, taikhoan, email, matkhau, ngaysinh, anh);
	...
	public boolean kiemtrathongtinbotrong() {
		if (textFieldHo.getText().equals("") && textFieldEmail.getText().equals("")
				&& textFieldNgaySinh.getText().equals("") && textFieldTen.getText().equals("")
				&& textFieldTenTaiKhoan.getText().equals("")) {
			JOptionPane.showInternalMessageDialog(this, "Bạn đã bỏ trống thông tin quan trọng");
			return false;
		}
		return true;
	}
