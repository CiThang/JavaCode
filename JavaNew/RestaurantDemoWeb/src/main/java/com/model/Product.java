...
public class Product {
		...
		public Product(String productID, String product_name, Double price, String image, Date date) {
			this.productID = productID;
		...
		public Product(String product_name, String status) {
			this.product_name = product_name;
			this.status = status;
		}
		...
		public String toString() {
			return "Product [id=" + id + ", productID=" + productID + ", productName=" + product_name + ", type=" + type
