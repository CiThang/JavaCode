...
public class CustomerAccountService {
	...
	public void updateCustomerAccount(String cusname, String email, String password, SecretKey secretKey) {
		customerAccountRepository.updateCustomerAccount(cusname, email, password, secretKey);
	}
